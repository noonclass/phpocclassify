            ...
            <form action="<?php echo osc_admin_base_url(true); ?>" method="post">
                ...
                <fieldset>
                    <div class="form-horizontal">
                        ...
                        <div class="form-row">
                            <div class="form-label"> <?php _e('Link length'); ?></div>
                            <div class="form-controls">
                                <div class="separate-top-medium">
                                    <?php printf( __('%s characters '), '<input type="text" class="input-small" name="max_chars_per_link" value="' . osc_max_characters_per_link() . '" />' ); ?>
                                </div>
                            </div>
                        </div>
                        <div class="form-row">
